...
type Config struct {
	// DisableVisionSniffReplay: true 时 mydispatcher 不做 Vision sniff/replay，用于对照「lookup canceled」类问题。
	DisableVisionSniffReplay bool              `mapstructure:"DisableVisionSniffReplay"`
